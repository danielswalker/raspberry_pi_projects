...
class ButtonMonitoringServicer(object):
    """Missing associated documentation comment in .proto file."""
...
def add_ButtonMonitoringServicer_to_server(servicer, server):
    rpc_method_handlers = {
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'ButtonMonitoring', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))


 # This class is part of an EXPERIMENTAL API.
class ButtonMonitoring(object):
    """Missing associated documentation comment in .proto file."""

    @staticmethod
    def HandleButtonEvent(request,
            target,
            options=(),
